...
const officeData = [
  ...
  {
    city: 'ABU DHABI',
    address: '19th Floor - 606 Hamdan Bin Mohammed St - Al Danah - E3-02 - Abu Dhabi, UAE',
    phone: '+971 55 3486 284',
    image: '/images/dubai.png',
  },
  {
    city: 'SAUDI ARABIA',
    address: 'Prince Sultan Bin Abdulaziz Rd, Al Mathar Ash Shamali, Riyadh, Saudi Arabia',
    phone: '+971 55 3486 284',
          ...
          <Div className="cs-footer_global_offices pb-lg-0">
              ...
              {officeData.map((office, index) => (
                <Div key={index} className="col-lg-3 col-md-6 col-sm-12">
                  <Div className="cs-office_card">
                    ...
                    <a href={`tel:${office.phone.replace(/\s/g, '')}`} className="cs-office_phone">
                      {office.phone}
                    </a>
                  </Div>
                </Div>
            ...
            <Div className="cs-footer_contact_info text-center">
              <p className="cs-contact_text">
                ...
                <a href="mailto:saad@adwebstudio.com" className="cs-email_link">
        ...
        <Div className="container">
          <Div className="cs-bottom_footer_in">
            ...
            <Div className="cs-footer_social">
              <a href="https://www.facebook.com/adwebstudiodubai/" target="_blank" rel="noopener noreferrer">
                <Icon icon="fa:facebook" />
              </a>
              <a href="https://www.instagram.com/adwebstudiouae/" target="_blank" rel="noopener noreferrer">
                <Icon icon="fa:instagram" />
              </a>
              <a href="https://x.com/ADWEB_Studio" target="_blank" rel="noopener noreferrer">
                <Icon icon="fa:twitter" />
              </a>
              <a href="https://www.youtube.com/user/dubaiadwebstudio" target="_blank" rel="noopener noreferrer">
