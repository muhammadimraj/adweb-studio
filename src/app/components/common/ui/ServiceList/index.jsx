...
const serviceData = [
  ...
  },
  {
    title: 'UI/UX Design',
    subtitle:
      'Craft intuitive interfaces that deliver exceptional experiences.\nData-driven approach ensuring seamless user engagement.\nStrategically placed elements to achieve your business goals.',
    imgUrl: '/images/ui-design.jpg',
    href: '/service/service-details',
  },
  {
    title: 'App Development',
    subtitle:
      'Transform ideas into powerful mobile and web applications.\nScalable, high-performance apps using cutting-edge technologies.',
    imgUrl: '/images/app-development.jpg',
    href: '/service/service-details',
  },
  {
    title: 'Social Media Marketing',
    subtitle:
      'Amplify your brand presence across social media platforms.\nEngaging content strategies resonating with target audiences.',
          ...
          <Link href={item.href} className="cs-iconbox cs-style3">
            <>
              ...
              <Div className="cs-iconbox_in">
                ...
                <Div className="cs-iconbox_subtitle" style={{ whiteSpace: 'pre-line' }}>{item.subtitle}</Div>
              </Div>
            </>
          </Link>
        </Div>
